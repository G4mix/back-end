...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/api/v1/hello-world',
            ...
            ...(fetchMiddlewares<RequestHandler>(HelloWorldController.prototype.helloWorld)),

            async function HelloWorldController_helloWorld(request: ExRequest, response: ExResponse, next: any) {
